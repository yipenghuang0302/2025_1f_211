...
if len( sys.argv ) > 1:
    ...
    total += fermiDirac_autograder.grade_fermiDirac ( path="tar_test/fermiDirac/", verbose=True )

    shutil.rmtree("tar_test")

else:

    total += fermiDirac_autograder.grade_fermiDirac ( path="fermiDirac/", verbose=True )
